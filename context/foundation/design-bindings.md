...
2026-09-08. The rule *text* is fingerprinted, never the token values, so a
...
| 4.1 One family | `d8616421f20b` | `ee768ade` | `PLEXMONO` |
| 4.2 Two tiers, set by viewing distance | `b971f23ef550` | `7108856c` | `DISTANCES` |
...
| Open questions | `4d7f03c21c97` | `f42da1a9` | `SCHEMAV2ADOPT` |
| Open questions | `4d7f03c21c97` | `156d8b7d` | `DENSITY` |
